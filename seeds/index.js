...
const seedDB = async () => {
  ...
  for (let i = 0; i < 15; i++) {
    ...
    const camp = new Campground({
      ...
      description:
        "Lorem ipsum dolor, sit amet consectetur adipisicing elit. Possimus deleniti quia rerum accusamus ipsa ipsam, quis eius obcaecati distinctio consequuntur laboriosam perspiciatis facere architecto doloremque, fuga illum adipisci ea iure!",
      price,
      geometry: {
        type: "Point",
        coordinates: [
